-- ========================================
-- Fix Scoring Logic - Apply This in Supabase SQL Editor
-- ========================================
-- This migration fixes the scoring bug where scores were always 0-0
-- Run this SQL directly in Supabase SQL Editor to update the functions

-- ========================================
-- 1. Update submit_round_answer to calculate actual scores
-- ========================================
...
-- ========================================
-- 2. Update evaluate_round to include total scores
-- ========================================
