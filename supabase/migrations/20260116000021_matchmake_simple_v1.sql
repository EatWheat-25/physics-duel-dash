-- 20260116000021_matchmake_simple_v1.sql
-- Atomic matchmaking RPC to prevent double-match race.
...
begin
  ...
  insert into public.matchmaking_queue (
    player_id, status, subject, level, created_at
  ) values (
    p_player_id, 'waiting', p_subject, p_level, now()
  )
  ...
  -- Find earliest compatible opponent who is still waiting.
  select *
  into v_opponent
