-- 20251224000001_submit_round_answer_v2_variable_options.sql
-- Allow submit_round_answer_v2 to support variable MCQ option counts (2–6) while
-- keeping True/False constrained to 2 options.
--
-- The game server validates 0-5, but the DB remains the source of truth and
-- validates against the active question's actual option count.
