-- 20260120000002_submit_round_answer_v2_no_draw_points.sql
-- Persist round results to match_rounds and enforce no points on draw.
...
begin
  ...
  -- No points on draw: only increment on a decisive winner
