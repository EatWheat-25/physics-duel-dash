-- 20260601000008_fix_request_early_answer_v1.sql
-- match_rounds has no "phase" column in this schema (only "status");
-- referencing v_round.phase made the function fail at runtime.
...
begin
  ...
  if coalesce(v_round.status, 'main') <> 'main' then
