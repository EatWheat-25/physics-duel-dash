...
const FortniteStyleShowcase: React.FC<FortniteStyleShowcaseProps> = ({
  ...
  return <div className="flex-1 flex items-center justify-center p-8 relative overflow-hidden">
      ...
      ease: "easeOut"
        ...
        repeat: Infinity,
        ease: "linear"
      }} className="relative cursor-pointer group" onClick={onCharacterClick}>
          ...
          {/* Holographic Ring */}
          <motion.div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-72 h-72 rounded-full border-2 border-primary/30" animate={{
          rotate: [0, 360],
          scale: [1, 1.05, 1]
        }} transition={{
          rotate: {
